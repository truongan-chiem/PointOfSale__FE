...
import { AiOutlinePlusCircle, AiOutlineCloseCircle, AiOutlineLoading, AiOutlineSearch } from "react-icons/ai";
  ...
  return (
    <div className="table-account">
      ...
      <Input
          ...
          value={searchValue}
          icon={
            isLoading ? <AiOutlineLoading className="loadingSearch" /> : <AiOutlineSearch />
          }
          />
      <div className="table">
            ...
            (item, index) =>
              item._id !== user._id && (
                <div className="table__body__row" key={`account-row-${item._id}`}>
                  <div className="table__body__row-item">{item.firstName + " " + item.lastName}</div>
